...
<svelte:head>
    <title>7wlite | Product First Use Experiences | Europe and U.S.</title>
    <meta name="description" content="We build product first time use experiences that help companies delight potential customers. Cross the bridge between acquisition and conversion by showing people that they came to the right product.">
</svelte:head>

<section class="box flex hero">
    <hgroup class="flex-3 flex-6-sm hero__message">
    <h1>First Impressions That Make All the Difference</h1>
    <h4>We build product first time use experiences that help companies delight potential customers. Make it easy for your new customers to get what they need and never count on the user's patience to master your product.</h4>
    <a href="#contact" class="js-scroll button hero__button">Request a call</a>
    </hgroup>
    <figure class="hero__illustration-box">
        <svg class="hero__illustration" viewBox="0 0 1092 433" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
            <defs>
...
<main class="foundation">
    <header class="box flex">
        <hgroup class="flex-4 flex-5-md">
        <h2>As movies have trailers, products need first use experiences cuts</h2>
    ...
    <section class="box foundation__items">
        <ul class="grid row-3 gap-20 column-3-md">
            <li class="panel foundation__panel">
                <h3>Drastically reduce acquisition costs</h3>
                <p>Stop worrying about shipping all the time and start delivering experiences that delight customers and bring your business solid results</p>
            </li>
            <li class="panel foundation__panel">
                <h3>Improve product-market fit</h3>
                <p>Reshape your first use experience around what new customers love and modify or eliminate the aspects of the experience that add no value</p>
            </li>
            <li class="panel foundation__panel">
                <h3>It's not about tooltips</h3>
                <p>When was the last time you read one of these? People learn the most by doing.</p>
            </li>
        </ul>
    </section>

    <article class="box flex flex-row column-md">
        ...
        <ol class="flex flex-3 flex-6-sm column self-end-md foundation__questions">
            <li class="foundation__question">
                <h4 class="foundation__question-phrase">We talk to people when they are first using your product and dig deeper to understand what brought them to you</h4>
            </li>
            <li class="foundation__question">
                <h4 class="foundation__question-phrase">We build the ideal narrative, so people feel safe and confident that your product will solve their need</h4>
            </li>
            <li class="foundation__question">
...
<section class="services" name="services">
    <header class="box services__header">
        <span class="services__title">Services</span>
    </header>
    <ul class="box grid row-3 column-3-md gap-20">
        <li class="panel panel--secondary services__panels">
            <h2>Baseline analysis</h2>
            <p>We understand where your current product first use experience stands today.</p>
            <p>If you have metrics, we'll dive into them. If not, we'll help you put it in place.</p>
        </li>
        <li class="panel panel--secondary services__panels">
            <h2>Design</h2>
            <p>We'll create a special cut from your product. Your customers will experience what is like to fix a problem, achieve a goal, or solve a need with practical tasks.</p>
        </li>
        <li class="panel panel--secondary services__panels">
            <h2>Validation</h2>
            <p>Once the experience is in place, we'll monitor how it goes to check if key aspects were improved.</p>
        </li>
    </ul>
</section>

<article class="cases" name="cases">
    <section class="box flex reverse-sm cases__section">
        <figure class="flex flex-3 flex-6-sm middle center cases__figure cases__figure--photoday">
            <a class="button" href="https://marvelapp.com/10ib6914" target="_blank">Experience it</a>
        </figure>
        <aside class="flex-3 flex-6-sm self-center cases__details">
            <header>
                <h6>Cases</h6>
                <h1>PhotoDay</h1>
            </header>
            <ul class="flex cases__tags">
                <li class="cases__tag">Startup</li>
                <li class="cases__tag">Photography</li>
                <li class="cases__tag">Market place</li>
            </ul>
            <p>When you disrupt a market, it's crucial to teach people new fundamentals. This marketplace for studios/photographers and parents needed a first-use experience that could onboard customers and show them how to customize products and place their first order.</p>
        </aside>
    </section>
</article>
...
<section class="value">
    <div class="box">
        <h1 class="value__title">It's a waste to acquire a customer if they're jumping off once they try your product</h1>
        <ul class="grid column-3 gap-30 value__values">
            <li class="grid gap-20 middle-md top-sm value__question">
                <div class="flex middle center top-sm start-sm panel value__panel">
                    <i class="icon-cheap"></i>
                </div>
                <p class="value__description">Are you facing increasing customer acquisition costs? Is it getting harder and harder to convert a paying customer?</p>
            </li>
            <li class="grid gap-20 middle-md top-sm value__question">
                <div class="flex middle center top-sm start-sm panel value__panel">
                    <i class="icon-no-chat"></i>
                </div>
                <p class="value__description">Have your customer support costs gone wild? Always answering the same questions? Never ending tutorials?</p>
            </li>
            <li class="grid gap-20 middle-md top-sm value__question">
                <div class="flex middle center top-sm start-sm panel value__panel">
                    <i class="icon-skip"></i>
                </div>
                <p class="value__description">That new onboarding feature, with lots of tooltips, is being ignored by 99% of your new users?</p>
            </li>
        </ul>
    </div>
</section>
...
<footer class="footer">
    <aside class="box hidden js-thanks">
        <h5 class="text--success text--nomargin">Thank you for reaching out to us</h5>
        <p>We will get back to you shortly</p>
    </aside>

    <aside class="box hidden js-error">
        <h5 class="text--error text--nomargin">Sorry, but something went wrong</h5>
        <p>Please, try to send your message again</p>
    </aside>

    <h2 class="box footer__title opaque js-title">Let's talk about how people should be meeting your product?</h2>

    <form class="box footer__contact visible js-form" name="contact">
        <fieldset class="flex-2 flex-6-sm">
            <label for="name">Name*</label>
            <input id="name" type="text" name="name" maxlength="50" autocomplete="name" required />
            ...
            <textarea id="message" name="message" rows="4" maxlength="144"></textarea>

            <small class="text--uppercase">*Required fields</small>

            <div class="g-recaptcha footer__contact-recaptcha" data-sitekey="6LdCtq0UAAAAAK3EfLszD2Cwd3qSEqnHRB3A22vk"></div>

            <button class="button button--block footer__contact-button js-send" name="button" type="submit">Send message</button>
        </fieldset>
    </form>

    <address class="box flex h-card footer__address">
        <span class="p-company">7wlite<i class="footer__address-bullet">•</i></span>
        <span class="p-locality">Orlando, FL, USA<i class="footer__address-bullet">•</i>Lisbon, Portugal</span>
    </address>
</footer>
